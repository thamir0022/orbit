export enum AuthResponseMessage {
  ...
  SIGNUP_RESEND_OTP = 'We’ve sent a new verification code to your email.',
  SIGNUP_VERIFY_SUCCESS = 'Email verified successfully.',
  SIGNUP_DETAILS_SUCCESS = 'Your account details have been saved.',
  SIGNUP_COMPLETE_SUCCESS = 'Your workspace has been created successfully.',
  ...
  SIGN_OUT_SUCCESS = 'Your are sign out successfully',
}
